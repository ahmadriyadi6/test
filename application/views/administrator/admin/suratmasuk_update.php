        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Surat Masuk</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<section class="content">
      ...
      <div class="row">  
        ...
        <div class="col-md-12">
        <?php foreach($tb_suratmasuk as $ct) : ?>
           <?php echo form_open_multipart('administrator/admin/suratmasuk/update_aksi'); ?>
         ...
         <button type="submit" class="btn btn-primary mb-5">Simpan</button>
              <?php echo anchor('administrator/admin/suratmasuk','<div class="btn mb-5 btn-primary">Kembali</div>') ?> 
              <?php echo form_close(); ?>
            <?php endforeach; ?>
    </div>
