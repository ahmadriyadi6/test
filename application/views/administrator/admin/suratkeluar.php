          ...
          <div class="card">
            ...
            <?php echo $this->session->flashdata('pesan') ?>
              <div class="card-body">   
                ...
                <?php echo anchor('administrator/admin/suratkeluar/input','<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-mr"></i> Tambah </button>') ?>
                ...
                foreach ($tb_suratkeluar as $ct) : ?>
                 <tr align="center">
                      ...
                      <td class="project-actions text-left">                        
                          ...
                          <a width="20px"><?php echo anchor('administrator/admin/suratkeluar/update/'.$ct->id,'<div class="btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></div>') ?>
                          </a>
                          <a width="20px"><?php echo anchor('administrator/admin/suratkeluar/delete/'.$ct->id,'<div class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?>
                          </a>
                      </td>
